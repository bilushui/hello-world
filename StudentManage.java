...
public class StudentManage {
	private static StudentManage[] s = new StudentManage[100];//录入学生上限
	int n = 0;
	private String name;
	private int num;
	...
	//判断是否有录入学生信息
	public void juge() throws IOException{
		int i;
		char ch;
		String str;
		Scanner In = new Scanner(System.in);
		if(n == 0){
			System.out.println("您还没有录入任何学生信息，是否录入(Y/N):");
			str = In.next();
			ch = str.charAt(0);
	...
	public void add() throws IOException{
		...
		int i,num1,t =1;
		char ch,ch1;
		FileWriter fw = new FileWriter("student.txt",true);//将学生信息录入指定的txt文件。
	...
	public void delete() throws IOException{
		...
		if(k == 0){
			System.out.println("您要删除的学号不存在，系统将返回主菜单");
			this.menu();
		}
		if(k == 1){
			...
			if(ch == 'Y' || ch == 'y'){
				...
				n--;
				System.out.println("学生数据成功删除，系统返回主菜单");
				this.menu();
			}
			if(ch == 'N' || ch == 'n'){
				System.out.println();
	...
	public void modif() throws IOException{
		...
		if(k == 0){
			System.out.println("您要修改的学号不存在，系统将返回主菜单");
			this.menu();
		}
		if(k == 1){
			...
			while (c == 1) {
				if (ch == 'Y' || ch == 'y') {
	                    ...
	                    moi = pin.nextInt();
	                    switch(moi){
	                    	case 1:System.out.println("请输入新的学号");num3 = pin.nextInt();s[t].num = num3;break;
	                    	case 2:System.out.println("请输入新的班级");str1 = pin.next();s[t].classAge = str1;break;
	                    	case 3:System.out.println("请输入新的姓名");str2 = pin.next();s[t].name = str2;break;
	                    }
